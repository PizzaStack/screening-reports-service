...
--  SCREENER
--------------------------------------------------------
CREATE SEQUENCE    SCREENER_SEQUENCE  MINVALUE 1  INCREMENT BY 1 START WITH 4321;
INSERT INTO SCREENER (SCREENER_ID,NAME) VALUES (SCREENER_SEQUENCE.NEXTVAL, 'Smith, John');
INSERT INTO SCREENER (SCREENER_ID,NAME) VALUES (SCREENER_SEQUENCE.NEXTVAL, 'Jackson, Janet');
INSERT INTO SCREENER (SCREENER_ID,NAME) VALUES (SCREENER_SEQUENCE.NEXTVAL, 'Walker, Paul');
...
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4325, 2, 'SCREENED', (SYSDATE+17));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4326, 3, 'SCREENED', (SYSDATE+2));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4325, 4, 'PENDING', (SYSDATE+6));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4321, 5, 'SCREENED', (SYSDATE+35));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4326, 6, 'PENDING', (SYSDATE+6));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4332, 7, 'PENDING', (SYSDATE+1));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4332, 8, 'PENDING', (SYSDATE+13));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4336, 9, 'SCREENED', (SYSDATE+4));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4326, 10, 'PENDING', (SYSDATE+9));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4333, 11, 'SCREENED', (SYSDATE+12));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4333, 12, 'SCREENED', (SYSDATE+11));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4333, 13, 'PENDING', (SYSDATE+9));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4325, 15, 'PENDING', (SYSDATE+8));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4332, 16, 'PENDING', (SYSDATE+2));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4336, 17, 'PENDING', (SYSDATE+19));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4326, 18, 'SCREENED', (SYSDATE+24));
insert into SCHEDULED_SCREENING (SCHEDULED_SCREENING_ID, candidate_id, SKILL_TYPE_ID, status, scheduled_date) values (SCHEDULED_SCREENING_SEQUENCE.NEXTVAL, 4325, 19, 'SCREENED', (SYSDATE+20));
...
values (SCREENING_SEQUENCE.NEXTVAL, 3, 2, 50.0, 'intoComment','generalComment','softskillComment', '2018-03-01', '2018-03-02', 0, 'Completed', 4321);
 
Insert into SCREENING (ID, SCREENER_ID, SKILL_TYPE_ID,
COMPOSITE_SCORE, ABOUT_COMMENT, GENERAL_COMMENT, SOFT_SKILL_COMMENT,
 START_DATE, END_DATE, SOFT_SKILL_VERDICT, STATUS, SCHEDULED_SCREENING_ID) 
values (SCREENING_SEQUENCE.NEXTVAL, 3, 2, 50.0, 'intoComment2','generalComment2','softskillComment2', '2018-03-02', '2018-03-03', 0, 'Completed', 4322);
...
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10007, 414, 4321, 5, 'good', '2018-03-01');
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10008, 414, 4321, 1, 'Bad wording, not sure they understand', '2018-03-01');
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10009, 414, 4322, 3, 'Basic knowledge, average.', '2018-03-01');
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10004, 416, 4322, 2, 'some understanding.', '2018-03-01');
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10005, 416, 4322, 5, 'good', '2018-03-01');
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10001, 415, 4322, 5, 'good', '2018-03-01');
Insert into QUESTION_SCORE (QUESTION_SCORE_ID, QUESTION_ID, BUCKET_ID, SCREENING_ID, SCORE, COMMENT, TIME)
values (QUESTION_SCORE_SEQUENCE.NEXTVAL, 10002, 415, 4322, 1, 'Bad wording, not sure they understand', '2018-03-01');
